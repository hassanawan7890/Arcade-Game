...
public class ChessCheckmateDetector {
    private Board b;
    ...
    private ChessKing bk;
    private ChessKing wk;
     ...
     */
    public ChessCheckmateDetector(Board b, LinkedList<Piece> wPieces, 
            LinkedList<Piece> bPieces, ChessKing wk, ChessKing bk) {
        this.b = b;
    ...
    public void update() {
        ...
        while (wIter.hasNext()) {
            ...
            if (!p.getClass().equals(ChessKing.class)) {
     ...
     */
    private boolean canEvade(Map<Square,List<Piece>> tMoves, ChessKing tKing) {
        boolean evade = false;
    ...
    private boolean canCapture(Map<Square,List<Piece>> poss, 
            List<Piece> threats, ChessKing k) {
    ...
    private boolean canBlock(List<Piece> threats, 
            Map <Square,List<Piece>> blockMoves, ChessKing k) {
        ...
        if (threats.size() == 1) {
            ...
            if (tC.equals(ChessPawn.class) || tC.equals(ChessBishop.class)) {
                int kX = ks.getXNum();
                int kY = ks.getYNum();
                int tX = ts.getXNum();
                int tY = ts.getYNum();
